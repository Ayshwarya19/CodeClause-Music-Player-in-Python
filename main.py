...
frameCnt = 30
frames = [PhotoImage(file='Up2T.gif',format = 'gif -index %i' %(i)) for i in range(frameCnt)]
...
Button(root, text="Browse Music", width=59, height=1, font=("calibri",
      12, "bold italic"), fg="Black", bg="#FFFFFF", command=AddMusic,anchor="center",padx=5).place(x=0, y=550)
